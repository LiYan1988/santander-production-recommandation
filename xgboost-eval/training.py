...
def _train_internal(params, dtrain,
                    ...
                    obj=None, feval=None,
                    xgb_model=None, callbacks=None, **kwargs_eval):
    ...
    for i in range(start_iteration, num_boost_round):
        ...
        if len(evals) != 0:
            bst_eval_set = bst.eval_set(evals, i, feval, **kwargs_eval)
...
def train(params, dtrain, num_boost_round=10, evals=(), obj=None, feval=None,
          ...
          verbose_eval=True, xgb_model=None, callbacks=None, learning_rates=None, **kwargs_eval):
    ...
    return _train_internal(params, dtrain,
                           ...
                           evals=evals,
                           obj=obj, feval=feval,
                           xgb_model=xgb_model, callbacks=callbacks, **kwargs_eval)
